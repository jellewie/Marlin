...
#define STRING_CONFIG_H_AUTHOR "JW" // Who made the changes.
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -2.87    // Z offset: -below +above  [the nozzle]
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define RIGHT_PROBE_BED_POSITION (X_BED_SIZE - 62)
